        ...
        <div class="bg-white p-8 rounded-2xl shadow-xl border border-slate-200/80 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
                ...
                <div>
                    ...
                    <input type="text" name="offer_letter" id="offer_letter" value="{{ old('offer_letter', $selectedOffer->no_surat ?? 'WCS-26-0927_J25-5438-01') }}" class="w-full px-3 py-2 rounded-xl border border-slate-300 text-xs font-bold">
                </div>
                <div>
            ...
            <div>
                ...
                <input type="text" name="job_project" id="job_project" value="{{ old('job_project', $selectedOffer->project_no ?? 'WCS-26-0927_J25-5438-01') }}"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        offerSelect.addEventListener('change', function() {
            ...
            if (opt.value) {
                ...
                if (opt.dataset.project) document.getElementById('job_project').value = opt.dataset.project;
            }
        });
    });
</script>
