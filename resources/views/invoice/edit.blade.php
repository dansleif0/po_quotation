            ...
            <fieldset class="border-t pt-6 mt-8">
                ...
                <div class="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
                    ...
                    <div class="flex items-center">
                        <input id="tampilkan_comp_b" name="tampilkan_comp_b" type="checkbox" value="1" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded cursor-pointer" {{ !empty($invoice->tampilkan_comp_b) ? 'checked' : '' }}>
