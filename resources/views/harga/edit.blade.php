        ...
        <form action="{{ route('harga.update', $product->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="generic" id="generic" value="{{ old('generic', $product->generic) }}"
                ...
                <div>
                    ...
                    <select name="primer_topcoat" id="primer_topcoat"
                        ...
                        <option value="Primer" {{ old('primer_topcoat', $product->primer_topcoat) == 'Primer' ? 'selected' : '' }}>Primer</option>
                        <option value="Topcoat" {{ old('primer_topcoat', $product->primer_topcoat) == 'Topcoat' ? 'selected' : '' }}>Topcoat</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="category" id="category"
                        ...
                        <option value="Marine" {{ old('category', $product->category) == 'Marine' ? 'selected' : '' }}>Marine</option>
                        <option value="Marine & PC" {{ old('category', $product->category) == 'Marine & PC' ? 'selected' : '' }}>Marine & PC</option>
                        <option value="PC - Floor Coating" {{ old('category', $product->category) == 'PC - Floor Coating' ? 'selected' : '' }}>PC - Floor Coating</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="thinner" id="thinner" value="{{ old('thinner', $product->thinner) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="number" name="price_per_l" id="price_per_l" value="{{ old('price_per_l', $product->price_per_l ?? $product->harga) }}"
                ...
                <div id="packing-container" class="space-y-2.5">
                    @forelse ($product->packings as $packing)
                        <div class="packing-row flex items-center gap-2">
                            <input type="text" name="packing_sizes[]" value="{{ $packing->packing_size }}"
                                   placeholder="Contoh: 2.5 L atau 20 L"
                    ...
                    @empty
                        <div class="packing-row flex items-center gap-2">
                            <input type="text" name="packing_sizes[]" value="{{ $product->packing_size }}"
                                   placeholder="Contoh: 2.5 L atau 20 L"
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-gray-800 focus:ring-gray-800 text-sm">
                            <button type="button" class="remove-packing-btn text-red-500 hover:text-red-700 hover:bg-red-50 p-2 rounded transition" title="Hapus">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div id="batch-container" class="space-y-2.5">
                    @forelse ($product->batches as $batch)
                        <div class="batch-row flex items-center gap-2">
                            <input type="text" name="batch_numbers[]" value="{{ $batch->batch_number }}"
